...
export const TYPICAL_LANE = {
  ...
  Morgana: 'Support', Senna: 'Support', Brand: 'Support', Swain: 'Support',
  Maokai: 'Support', TahmKench: 'Support',
  ...
  Shaco: 'Jungle', Fiddlesticks: 'Jungle', Udyr: 'Jungle', Trundle: 'Jungle',
  Diana: 'Jungle', Gragas: 'Jungle',
  ...
  Kennen: 'Top', Jayce: 'Top', Gwen: 'Top', Wukong: 'Top', MonkeyKing: 'Top', Volibear: 'Top',
  Kayle: 'Top', Teemo: 'Top', Chogath: 'Top', DrMundo: 'Top', Quinn: 'Top',
  Pantheon: 'Top', Singed: 'Top', Kled: 'Top',
  ...
  Akshan: 'Mid', Mel: 'Mid', Irelia: 'Mid', Ziggs: 'Mid', Heimerdinger: 'Mid',
  Naafiri: 'Mid', Talon: 'Mid',
};
